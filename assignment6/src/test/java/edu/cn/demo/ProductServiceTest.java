...
public class ProductServiceTest {
    ...
    @Test
    public void getTest() throws ProductException {
        Product product = new Product();
        product.setName("《范特西》");
    ...
    @Test
    public void changeTest() throws ProductException {
        Product product = new Product();
        product.setName("《丑奴儿》");
    ...
    public void deleteTest() throws ProductException {
        ...
        assertThrows(ProductException.class, ()-> service.searchById(id));
    }


    //新增的测试函数
    @Test
    public void searchByProductIdWithSuppliersTest() throws ProductException {
        Integer id = service.searchByName("《郭源潮》").getId();
    ...
    @Test
    public void testAspect() throws ProductException {
        Integer id = service.searchByName("《郭源潮》").getId();
